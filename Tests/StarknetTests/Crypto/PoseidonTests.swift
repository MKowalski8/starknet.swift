...
final class PoseidonTests: XCTestCase {
    ...
    func testPoseidonHashSingleBigNumber() throws {
        let value = try XCTUnwrap(Felt(BigUInt("737869762948382064636737869762948382064636737869762948382064636")))
    ...
    func testPoseidonHashDoubleBigNumbers() throws {
        let value = try XCTUnwrap(Felt(BigUInt("737869762948382064636737869762948382064636737869762948382064636")))
    ...
    func testPoseidonHashManyBigNumbers() throws {
        let value1 = try XCTUnwrap(Felt(BigUInt("737869762948382064636737869762948382064636737869762948382064636")))
        let value2 = try XCTUnwrap(Felt(BigUInt("948382064636737869762948382064636737869762948382064636737869762")))
